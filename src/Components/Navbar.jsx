...
margin:'5px',
          ...
          <div className="items">
            <Link to="/marketplace" className="items" style={{
padding:'40px',
margin:'5px',
          ...
          <div className="items">
            <Link to="/groups" className="items" fill="blue" style={{
padding:'40px',
margin:'5px',
          ...
          <div className="items">
            <Link to="/gaming" className="items" style={{
padding:'40px',
margin:'5px',
...
display:'flex',
          ...
          <div className="items">
            <Link to="/menu" className="items" style={{
padding:'5px',
margin:'5px',
          ...
          <div className="items">
            <Link to="/messenger" className="items" style={{
padding:'5px',
margin:'5px',
          ...
          <div className="items">
            <Link to="/notification" className="items" style={{
padding:'5px',
margin:'5px',
          ...
          <div className="items">
            <Link to="/account" className="items" style={{
padding:'5px',
margin:'5px',
