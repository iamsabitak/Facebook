        ...
        <div className="left-content">
          ...
          <div className="scroll">
            ...
            <div className="filter">
              <h3 style={{ marginLeft: "24px" }}>Filter</h3>
              <Link to="#">Kathmandu,Nepal.Within 65 kilometers</Link>
            </div>
            <hr />
            <div className="Catagories">
              <h4>Catagories</h4>
              <div className="catagoriesLinks">
                <Link to="#">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
          ...
          <div className="todaysPicks">
            ...
            <div className="Heading">
              ...
              <div className="FirstRowStuff">
                ...
                <div className="card">
                  <img
                    src="https://i5.walmartimages.com/asr/9fbb13c4-23cf-4b41-b7f6-5a9391573795.73f22ebe7a7f7e1df85f022f4276c4bc.jpeg?odnHeight=768&odnWidth=768&odnBg=FFFFFF"
                    className="card-img-top"
                    alt="Upload Error"
                  />
                  <div className="card-body">
                ...
                <div className="card">
                  <img
                    src="https://img.ws.mms.shopee.ph/c418ad9502ae95d0097f107fff760e72"
                    alt="Upload Error"
                  />
                  <div className="card-body">
              ...
              <div className="ThirdRowStuff">
                <div className="card">
                  <img
                    src="https://cdn.stylevana.com/media/codazon_blog/cache/880x554/cropped_kh/codazon_blog_1689782915.jpg"
                    className="card-img-top"
                    alt="Upload Error"
                  />
                  <div className="card-body">
                ...
                <div className="card">
                  <img
                    src="https://www.rd.com/wp-content/uploads/2022/05/top-20-korean-beauty-products-ft-via-merchants.png"
                    className="card-img-top"
                    alt="Upload Error"
                  />
                  <div className="card-body">
                ...
                <div className="card">
                  <img
                    src="https://rukminim1.flixcart.com/image/850/1000/xif0q/watch/d/k/q/2-korean-led-combo-watches-style-square-latest-chronorex-men-original-imaghshznuhjnunc.jpeg?q=90"
                    className="card-img-top"
                    alt="Upload Error"
                  />
                  <div className="card-body">
